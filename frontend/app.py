...
from Classification.similarity_data import similarity_data
...
def main():
    ...
    with col1:
        st.image("C:/Users/alkrd/Desktop/graduation_project/the_project/Topic_Modeling/LDA_topic_modeling/visuals/lda_model_vis1.png")

    with col2:
        st.image("C:/Users/alkrd/Desktop/graduation_project/the_project/Topic_Modeling/LDA_topic_modeling/visuals/lda_model_vis_2.png")
    ...
    url = f"{API_URL}/country_trend_model"
    payload = {'country': selected_country, "topic":selected_topic}
    ...
    st.markdown("[Trends_prediction_model](https://github.com/MohamedAlkurdi/Trends_prediction_model)")

...
entity_counts_every_day.to_csv(r'C:\Users\alkrd\Desktop\graduation_project\the_project\entity_counts_every_day_TEST.csv', header=True, index=True)
...
entity_counts_by_traffic.to_csv(r'C:\Users\alkrd\Desktop\graduation_project\the_project\traffic_entities_ratio_TEST.csv', header=True, index=True)
